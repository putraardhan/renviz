    ...
    <div>
      ...
      <section id="gallery" className="gallery-section">
        <div className="gallery-head">
          ...
          <h2 className="section-h2" style={{ marginLeft: "-3px" }}>Rendered with Renviz.</h2>
          <p className="section-sub" style={{ marginTop: "10px" }}>Real SketchUp models turned into photorealistic visuals. Every render below was generated by Renviz AI in seconds.</p>
        </div>
